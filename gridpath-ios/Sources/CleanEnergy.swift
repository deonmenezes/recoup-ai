...
enum CleanEnergy {
    ...
    static func plan(for address: String) -> CleanEnergyPlan {
        ...
        let options: [CleanEnergyOption] = [
            .init(icon: "☀️", name: "Rooftop Solar", recommended: true,
            ...
            .init(icon: "🔋", name: "Home Battery", recommended: true,
            ...
            .init(icon: "♨️", name: "Heat Pump", recommended: true,
            ...
            .init(icon: "🔌", name: "EV Charger", recommended: false,
